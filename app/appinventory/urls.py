...
urlpatterns = [
    ...
    path('api/warehouses-provider/', WarehouseListProviderAPIView.as_view(), name='warehouses-provider'),
    path('api/productcategory-provider/', ProductCategoryListProviderAPIView.as_view(), name='productcategory-provider'),
    path('api/pricetypes-provider/', PriceTypeListProviderAPIView.as_view(), name='pricetypes-provider'),
    path('api/unitsofmeasure-provider/', UnitOfMeasureListProviderAPIView.as_view(), name='unitsofmeasure-provider'),
    path('api/unitcategory-provider/', UnitCategoryListProviderAPIView.as_view(), name='unitcategory-provider'),
