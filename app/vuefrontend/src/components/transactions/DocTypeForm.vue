<template>
  <div class="container mt-4">
    ...
    <!-- Card Principal con estilo moderno -->
        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="form-section mb-4">
            ...
            <div class="row g-3">
              ...
              <div class="col-md-3">
                <label class="form-label mb-3">Affects Inventory</label>
                <div class="d-flex flex-column gap-3">
                  <div class="d-flex justify-content-between align-items-center">
                    <label class="form-check-label mb-0" for="affects_physical">Physical Inventory</label>
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <label class="form-check-label mb-0" for="affects_logical">Logical Inventory</label>
                    <div class="form-check form-switch">
                      <input
                        id="affects_logical"
              ...
              <div class="col-md-3">
                <label class="form-label mb-3">Additional Configuration</label>
                <div class="d-flex flex-column gap-3">
                  <div class="d-flex justify-content-between align-items-center">
                    <label class="form-check-label mb-0" for="affects_accounting">Affects Accounting</label>
                    <div class="form-check form-switch">
                      <input
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <label class="form-check-label mb-0" for="warehouse_required">Warehouse Required</label>
                    <div class="form-check form-switch">
                      <input
          ...
          <div class="form-section mb-4">
            ...
            <div class="row g-3">
              <div class="col-md-4">
                <div class="d-flex justify-content-between align-items-center">
                  <label class="form-check-label mb-0" for="is_purchase">Purchase Document</label>
                  <div class="form-check form-switch">
                    <input
                      id="is_purchase"
              ...
              <div class="col-md-4">
                <div class="d-flex justify-content-between align-items-center">
                  <label class="form-check-label mb-0" for="is_sales">Sales Document</label>
                  <div class="form-check form-switch">
                    <input
                      id="is_sales"
              ...
              <div class="col-md-4">
                <div class="d-flex justify-content-between align-items-center">
                  <label class="form-check-label mb-0" for="is_taxable">Subject to Taxes</label>
                  <div class="form-check form-switch">
                    <input
                      id="is_taxable"
          ...
          <div class="form-section mb-4">
            ...
            <div class="row g-3">
              <div class="col-md-6">
                <div class="d-flex justify-content-between align-items-center">
                  <label class="form-check-label mb-0" for="is_operational">Operational Document</label>
                  <div class="form-check form-switch">
                    <input
                      id="is_operational"
              ...
              <div class="col-md-6">
                <div class="d-flex justify-content-between align-items-center">
                  <label class="form-check-label mb-0" for="allow_negative_sales">Allow Negative Sales</label>
                  <div class="form-check form-switch">
                    <input
          ...
          <div class="form-section mb-4">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="d-flex justify-content-between align-items-center">
                  <label class="form-check-label mb-0" for="is_active">Active Document Type</label>
                  <div class="form-check form-switch">
                    <input
                      id="is_active"
          ...
          <div class="row mt-4">
            <div class="col-12">
              <div class="d-flex gap-3 justify-content-center">
                <button type="submit" class="btn btn-primary btn-rounded" :disabled="isViewMode || submitting">
                  <span
                    v-if="submitting"
                ...
                <button type="button" class="btn btn-secondary btn-rounded" :disabled="submitting" @click="handleCancel">
