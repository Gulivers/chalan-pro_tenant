  ...
  <TxCard class="shadow-sm mt-0">
    <template #header>
      <div
        ...
        <h5 class="text-primary mb-0 fw-semibold listview-title">Trucks</h5>
        <router-link
      ...
      <div class="listview-filters row g-2 g-md-3 mb-3 align-items-end">
        <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
          <div class="listview-filter-group">
            <label for="truck-per-page" class="form-label small mb-1">
              Entries per page:
            </label>
            <select
              id="truck-per-page"
        ...
        <div class="col-12 col-sm-6 col-lg-5 col-xl-4 ms-lg-auto">
          <div class="listview-filter-group">
            <label for="truck-search" class="form-label small mb-1">
              Search:
            </label>
