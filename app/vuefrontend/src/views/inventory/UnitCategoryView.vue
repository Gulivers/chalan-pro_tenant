      ...
      <BOverlay :show="isLoading" rounded="sm" opacity="0.85" variant="light">
        <template #overlay>
          <div class="text-center">
            ...
            <div class="h5 text-primary">Loading Unit Categories...</div>
        ...
        <BTable
          ...
          <template #cell(actions)="row">
            <div class="btn-group btn-group-sm">
              <button
                v-if="hasPermission('appinventory.view_unitcategory')"
                class="btn btn-outline-success me-1"
                @click="viewItem(row.item.id)">
                View
              </button>
              <button
                v-if="hasPermission('appinventory.change_unitcategory')"
                class="btn btn-outline-primary me-1"
                @click="editItem(row.item.id)">
                Edit
              </button>
              <button
                v-if="hasPermission('appinventory.delete_unitcategory')"
...
export default {
  ...
  setup() {
    ...
    const viewItem = (id) =>
      router.push({ name: "unit-category-view", params: { id } });
    const editItem = (id) =>
