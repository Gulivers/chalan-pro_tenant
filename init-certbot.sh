#!/bin/bash
# Script para inicializar Certbot y obtener certificados SSL
...
# Verificar que Nginx esté corriendo (necesario para el challenge)
...
echo "Obteniendo certificados SSL para $DOMAIN y www.$DOMAIN..."
